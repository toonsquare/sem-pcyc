...
def main():
    ...
    path_sketch_model = os.path.join(path_aux, 'CheckPoints', args.dataset, 'sketch') #/ml_data/sem_pcyc/aux/CheckPoints/[Dataset]/sketch
    path_image_model = os.path.join(path_aux, 'CheckPoints', args.dataset, 'image') #/ml_data/sem_pcyc/aux/CheckPoints/[Dataset]/image
    ...
    sem_pcyc_model = nn.DataParallel(sem_pcyc_model)
...
def validate(valid_loader_sketch, valid_loader_image, sem_pcyc_model, epoch, args):
    ...
    for i, (sk, cls_sk) in enumerate(valid_loader_sketch):
        ...
        sk_em = sem_pcyc_model.module.get_sketch_embeddings(sk)
    ...
    for i, (im, cls_im) in enumerate(valid_loader_image):
        ...
        im_em = sem_pcyc_model.module.get_image_embeddings(im)
